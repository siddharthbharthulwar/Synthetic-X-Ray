...
input_img_3 = Input(shape = (1024, 1024, 1))
input_img_4 = Input(shape = (1024, 1024, 1))
...
x = Conv2D(4, (3, 3), activation='relu', padding='same')(input_img_3)
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(4, (3, 3), activation='relu', padding='same')(x)
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(8, (3, 3), activation='relu', padding='same')(x)
...
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(512, (3, 3), activation='relu', padding='same')(x)
encoded_3 = MaxPooling2D((2, 2), padding='same')(x)

x = Conv2D(4, (3, 3), activation='relu', padding='same')(input_img_4)
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(4, (3, 3), activation='relu', padding='same')(x)
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(8, (3, 3), activation='relu', padding='same')(x)
...
x = MaxPooling2D((2, 2), padding='same')(x)
x = Conv2D(512, (3, 3), activation='relu', padding='same')(x)
encoded_4 = MaxPooling2D((2, 2), padding='same')(x)

encoded = concatenate([encoded_1, encoded_2, encoded_3, encoded_4])
...
autoencoder = Model(inputs=[input_img, input_img_2, input_img_3, input_img_4], outputs = decoded)